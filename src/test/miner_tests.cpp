...
static struct {
    ...
    {4, 0x00045526}, {2, 0x0000cdd8}, {1, 0x00134747}, {1, 0x000327b8},
    {2, 0x000f2318}, {2, 0x001925c1}, {1, 0x0002a902}, {2, 0x000f43ff},
    {2, 0x000060a4}, {1, 0x001c0206}, {1, 0x00457eb9}, {2, 0x004199b6},
    {2, 0x003ba7a2}, {1, 0x00008e07}, {2, 0x002a6a39}, {2, 0x00011e80},
    {1, 0x0001dfa6}, {2, 0x000156b3}, {1, 0x000dc25c}, {1, 0x0007786e},
    ...
    {1, 0x3141c7c1}, {1, 0xb3b595f4}, {1, 0x735abf08}, {5, 0x623bfbce},
    {2, 0xd351e722}, {1, 0xf4ca48c9}, {1, 0x5b19c670}, {1, 0xa164bf0e},
    {2, 0xbbbeb305}, {2, 0xfe1c810a}, {1, 0x5b19c670}, {1, 0xa164bf0e},
    {1, 0x3141c7c1}, {1, 0xb3b595f4}, {1, 0x735abf08}, {5, 0x623bfbce},
    {2, 0xd351e722}, {1, 0xf4ca48c9},
...
BOOST_AUTO_TEST_CASE(CreateNewBlock_validity)
{
    ...
    // Therefore, load 250 blocks :)
    static_assert(sizeof(blockinfo) / sizeof(*blockinfo) == 250, "Should have 250 blocks to import");
    int baseheight = 0;
    ...
    for (unsigned int i = 0; i < sizeof(blockinfo)/sizeof(*blockinfo); ++i)
    {
        ...
        if (i > 0 && i % 4 == 0) {
            ...
            for (unsigned int j = i - 4; j < i; j++) {
                printf(" {%d, 0x%08x},", blockinfo[j].extranonce, blockinfo[j].nonce);
            }
            printf("\n");
        }
