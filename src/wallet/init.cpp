...
void WalletInit::AddWalletOptions(ArgsManager& argsman) const
{
    ...
    argsman.AddArg("-sendfreetransactions", strprintf("Send transactions as zero-fee transactions if possible (default: %u)", DEFAULT_SEND_FREE_TRANSACTIONS), ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::WALLET_DEBUG_TEST);
